...
set(BMS_V1_default_default_XC8_FILE_TYPE_assemble)
set_source_files_properties(${BMS_V1_default_default_XC8_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${BMS_V1_default_default_XC8_FILE_TYPE_assemble})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(BMS_V1_default_default_XC8_FILE_TYPE_assemblePreprocess "${CMAKE_CURRENT_SOURCE_DIR}/../../../mcc_generated_files/system/src/protected_io.S")
set_source_files_properties(${BMS_V1_default_default_XC8_FILE_TYPE_assemblePreprocess} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${BMS_V1_default_default_XC8_FILE_TYPE_assemblePreprocess})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(BMS_V1_default_default_XC8_FILE_TYPE_compile
...
set(BMS_V1_default_image_name "default.elf")
set(BMS_V1_default_image_base_name "default")

# The output directory of the final image.
set(BMS_V1_default_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/BMS_V1")

# The full path to the final image.
set(BMS_V1_default_full_path_to_image ${BMS_V1_default_output_dir}/${BMS_V1_default_image_name})
...
set(output_extensions
    ...
    .sym
    .cmf)
list(TRANSFORM output_extensions PREPEND "${BMS_V1_default_output_dir}/${BMS_V1_default_image_base_name}")
